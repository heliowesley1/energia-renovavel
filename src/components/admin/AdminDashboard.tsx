                ...
                <TableBody>
                  {paginatedClients.map((client) => (
                    <TableRow key={client.id}>
                      ...
                      <TableCell><div className="max-w-[180px]"><p className="font-medium truncate">{client.name}</p><p className="text-xs text-muted-foreground truncate">{client.email || '-'}</p></div></TableCell>
                      <TableCell className="text-xs font-semibold">{client.cpf}</TableCell>
